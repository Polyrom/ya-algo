# https://contest.yandex.ru/contest/22781/run-report/134852895/
#
# -- ПРИНЦИП РАБОТЫ --
...
class Deque:
    ...
    def push_front(self, value: int) -> str | None:
        if self.is_full():
            return "error"
    ...
    def push_back(self, value: int) -> str | None:
        if self.is_full():
            return "error"
